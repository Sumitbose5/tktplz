    ...
    return (
        <div className="min-h-screen flex">
            ...
            <div className="w-1/2 bg-gradient-to-br from-blue-700 to-orange-500 text-white flex flex-col justify-center items-center p-10">
                ...
                <h1 className="text-4xl font-bold mb-4">Verify Your OTP</h1>
            ...
            <div className="w-1/2 flex items-center justify-center p-10">
                ...
                >
                    ...
                    <div>
                        <label htmlFor="inputOtp" className="block text-sm font-medium text-gray-600">
                            Enter OTP
                        </label>
                        <input
                            type="text"
                            id="inputOtp"
                            maxLength="6"
                            className="mt-1 block w-full px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-600 tracking-widest text-center text-xl"
                            value={inputOtp}
